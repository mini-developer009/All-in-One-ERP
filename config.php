...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	// Main Title
	$app_title = "NGICON ERP ( Next Generation icon ERP )";

	// Build for development purposes
//	$build_version 	= date("d.m.Y", filemtime("$path_to_root/CHANGELOG.txt"));

	// Powered by
	$power_by 		= "NGICON  ( Next Generation icon )";
	$power_url 		= "https://ngicon.com";
	...
	$help_base_url = 'https://ngicon.com/fawiki/index.php?n=Help.';
