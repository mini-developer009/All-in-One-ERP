...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	include_once($path_to_root . '/applications/barcode.php');
	include_once($path_to_root . '/applications/ecom.php');
	...
	class front_accounting
	{
		...
		function init()
		{
			...
			if (get_company_pref('use_pos'))	
			$this->add_application(new posmanage_app());				
