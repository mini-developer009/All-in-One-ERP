...
class Spreadsheet_Excel_Writer_Worksheet extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
                                                ...
                                                &$url_format, &$parser)
    {
		...
		$this->_rtl				  = 0; 	// Added by NGICON TEAM CHECKED 2009-03-05 for arabic languages
    ...
    */
    ...
    /** added 2009-03-05 by NGICON TEAM CHECKED, FA for arabic languages */
    function setRTL()
    {
    	$this->_rtl = 1;
    }	
...
/*        
        ...
        {										// corrected specification from M$ - NGICON TEAM CHECKED 2009-03-08
