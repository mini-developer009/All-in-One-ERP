...
class FrontHrm_app extends application {
    function __construct() {
        ...
        $this->add_lapp_function(0, _('Document E&xpiration HR'), $path_to_root.'/modules/FrontHrm/manage/employee_docs.php?', 'SA_ATTACHDOCUMENT', MENU_TRANSACTION);
        $this->add_lapp_function(0, _('Document E&xpiration Vehicle'), $path_to_root.'/modules/FrontHrm/manage/vehicle_docs.php?', 'SA_ATTACHDOCUMENT', MENU_TRANSACTION);
        
        $this->add_lapp_function(0, _('Fuel &Tracking Entry'), $path_to_root.'/modules/FrontHrm/manage/fuel_management.php?tab=fuellog', 'SA_ATTACHDOCUMENT', MENU_TRANSACTION);
        ...
        $this->add_rapp_function(1, _('Vehicle Document Inq&uiry'), $path_to_root.'/modules/FrontHrm/manage/vehicle_docs.php?View=yes', 'SA_EMPL', MENU_INQUIRY);
        
        $this->add_rapp_function(1, _('Fuel Tracking Inq&uiry'), $path_to_root.'/modules/FrontHrm/manage/fuel_management.php?View=yes', 'SA_EMPL', MENU_INQUIRY);
...
// ==========================================
// NEW: GOLD SHOP APP TAB
// ==========================================
class GoldShop_app extends application {
    function __construct() {
        global $path_to_root;
        parent::__construct('GoldShop', _('Gold Shop'));
        
        $this->add_module(_('Gold Management'));
        $this->add_lapp_function(0, _('Dashboard & Ledger'), $path_to_root.'/modules/FrontHrm/manage/gold_dashboard.php', 'SA_EMPL', MENU_TRANSACTION);
    }
}
...
class hooks_FrontHrm extends hooks {
    ...
    function install_tabs($app) {
        ...
        $app->add_application(new GoldShop_app); // Register the Gold Shop Tab!
    }
